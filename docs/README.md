...
- Providers: [Codex](./user/providers-codex.md) · [Claude](./user/providers-claude.md) · [ACP Registry](./user/providers-acp-registry.md)
...
- [Contextivity downstream](./operations/contextivity-downstream.md)
