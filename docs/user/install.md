...
ACP Registry is a generic adapter for Agent Client Protocol CLIs such as Contextivity. It is not
installed by default. Add it from **Settings** → **Add provider**. See
[ACP Registry](./providers-acp-registry.md).
